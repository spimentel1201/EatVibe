...
export default function ContactCustomerScreen() {
            ...
            <SafeAreaView edges={['top']} className="flex-1">
                ...
                <View className="flex-row items-center justify-between px-6 py-4 border-b border-[#1E293B]">
                    ...
                    <View className="flex-1 ml-4">
                        <Text className="text-white text-lg font-bold">{customerInfo.name}</Text>
                ...
                <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableOpacity
                        ...
                        className="bg-[#1A1F3A] rounded-2xl py-4 border border-[#F59E0B] flex-row items-center justify-center mt-4 mb-6"
                    >
                        <Ionicons name="warning" size={20} color="#F59E0B" />
                        <Text className="text-[#F59E0B] font-semibold ml-2">
                            Report Issue with Customer
                        </Text>
                    </TouchableOpacity>
